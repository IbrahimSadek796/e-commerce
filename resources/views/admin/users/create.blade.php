...
@section('content')
    ...
    <div class="page-content card">
        <form class="row g-3 card-body" action="{{ route('admin.users.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="col-12">
                ...
                <input class="form-control @error('email') is-invalid @enderror" id="inputEmail" name="email"
                    type="text" value="{{ old('email') }}" placeholder="Email...">
                @error('email')
                    <div class="alert alert-danger my-1">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="col-12">
                ...
                <input class="form-control @error('password_confirmation') is-invalid @enderror" id="inputPassword_confirmation"
