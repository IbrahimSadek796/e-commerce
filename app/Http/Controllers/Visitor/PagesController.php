...
class PagesController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('visitor.layouts.shope', compact('posts'));
    }
    public function showMen()
    {
        //
        $array = post::orderBy('id', 'DESC')->where('kind' , '=' , 'men')->paginate(9);
        return view('visitor.layouts.men', compact('array'));
    }
    ...
    public function showkids()
    {
        ...
        return view('visitor.layouts.kids', compact('kids'));
    }
    ...
    public function showwomen()
    {
        ...
        return view('visitor.layouts.women', compact('array'));
    }
    ...
    public function showAll()
    {
        ...
        return view('visitor.main', compact('array','men','women','kids', 'latest'));
    }
    ...
    public function show(string $id)
    {
        ...
        if (!$post) {
            return redirect(route('visitor.layouts.shop'))->with('error', 'Post not found!');
        }

        return view('visitor.layouts.show')->with([
            'post' => $post,
        ]);
    }
}
